...
namespace SmokeQuit.Repositories.LocDPX.DBContext;
...
public partial class SU25_PRN232_SE1731_G6_SmokeQuitContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=LOCDANG;Initial Catalog=SU25_PRN232_SE1731_G6_SmokeQuit;Persist Security Info=True;User ID=sa;Password=12345;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AchievementNhuNqid).HasName("PK__Achievem__E78F080422DE1511");
        ...
        {
            entity.HasKey(e => e.BlogPostsAnVtid).HasName("PK__BlogPost__837415F84F5A1C68");
        ...
        {
            entity.HasKey(e => e.ChatsLocDpxid).HasName("PK__ChatsLoc__27DEBDA05F0AA3EE");
        ...
        {
            entity.HasKey(e => e.CoachesLocDpxid).HasName("PK__CoachesL__24751D187C3F30B2");

            entity.ToTable("CoachesLocDPX");

            entity.HasIndex(e => e.Email, "UQ__CoachesL__A9D105345BF7FD7B").IsUnique();
        ...
        {
            entity.HasKey(e => e.LeaderboardsDuongLntid).HasName("PK__Leaderbo__347F6678AB9404BE");
        ...
        {
            entity.HasKey(e => e.MembershipPlansAnhDtnid).HasName("PK__Membersh__66D9431BCF6BBFFB");
        ...
        {
            entity.HasKey(e => e.ProgressRecordsHoangPxid).HasName("PK__Progress__7342863CA4CF891C");
        ...
        {
            entity.HasKey(e => e.QuitPlansAnhDtnid).HasName("PK__QuitPlan__F0642CC4A2F03BED");
        ...
        {
            entity.HasKey(e => e.SupportMethodsHoangPxid).HasName("PK__SupportM__C1A8BEAB73B1FE42");
        ...
        {
            entity.HasKey(e => e.UserAchievementNhuNqid).HasName("PK__UserAchi__C3D01462083C6FC8");
